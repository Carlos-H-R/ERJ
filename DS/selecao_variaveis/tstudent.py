...
for i in data.columns:
    ...
    print("Teste jarque_bera para avaliaros dados normalmente distribuídos:")
    print('atributo:', i)

    stat_normal, p_normal = stats.jarque_bera(data[i])
    ...
    if p_normal > 0.05:
        ...
        print("Os dados não parecem ser normalmente distribuídos.")
        print()
...
for i in data.columns:
    print("Teste shapiro para avaliaros dados normalmente distribuídos:")
    
    stat_normal, p_normal = stats.shapiro(data[i])
